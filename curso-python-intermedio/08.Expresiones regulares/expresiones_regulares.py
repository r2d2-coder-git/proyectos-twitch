...
"""
Las expresiones regulares son secuencias de caracteres que forman un patrón de búsqueda. Son útiles para encontrar, 
manipular, o validar texto.Python utiliza el módulo 're' para trabajar con expresiones regulares.
...
"""
Las expresiones regulares permiten buscar patrones dentro de cadenas de texto. Estos patrones pueden incluir 
caracteres especiales que tienen significados específicos. 
...
"""
Algunos caracteres tienen significados especiales en las expresiones regulares, como el punto (.), 
asterisco (*), más (+), etc. Si queremos buscar estos caracteres literalmente, 
...
"""
Las expresiones regulares son una herramienta poderosa para trabajar con texto. Son muy flexibles
y se pueden utilizar en muchas tareas como:
- Validación de datos (números de teléfono, correos electrónicos).
- Extracción de información.
- Búsquedas y reemplazos.

Sin embargo, las expresiones regulares pueden ser complejas y es fácil cometer errores si no se usan correctamente. 
Es importante probar bien las expresiones para asegurarse de que funcionan como se espera.
"""
